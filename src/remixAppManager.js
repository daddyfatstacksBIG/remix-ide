...
export class RemixAppManager extends PluginEngine {
  ...
  async registeredPlugins() {
    ...
    const provable = {
      ...
      documentation:
        "https://docs.oraclize.it/#development-tools-remix-ide-provable-plugin",
    ...
    const threeBox = {
      ...
      icon:
        "https://raw.githubusercontent.com/3box/3box-dapp/master/public/3Box3.png",
      location: "sidePanel"
    };
    const debugPlugin = {
      name: "debugPlugin",
    ...
    const libraTools = {
      ...
      description:
        "Create, compile, deploy and interact with Libra modules and scripts",
      icon:
    ...
    const gasProfiler = {
      ...
      icon:
        "https://res.cloudinary.com/key-solutions/image/upload/v1565781702/gas-profiler_nxmsal.png",
      location: "sidePanel"
    };
    const flattener = {
      name: "flattener",
