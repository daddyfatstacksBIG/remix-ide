...
const themes = [
  {
    ...
    quality: "dark",
    url:
      "https://res.cloudinary.com/dvtmp0niu/raw/upload/v1570118040/remix-dark-theme.css"
  },
...
export class ThemeModule extends Plugin {
  constructor(registry) {
    ...
    this.themes = themes.reduce(
      (acc, theme) => ({ ...acc, [theme.name]: theme }),
      {}
    );
    this.active = this._deps.config.get("settings/theme")
      ? this._deps.config.get("settings/theme")
      : "Flatly";
  }
